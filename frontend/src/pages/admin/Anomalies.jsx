...
export default function AdminAnomalies() {
  ...
  useEffect(() => {
    fetchAnomalies();
    const interval = setInterval(fetchAnomalies, 3000); // Refresh every 3 seconds
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            💡 <strong>About Anomalies:</strong> System automatically detects duplicate logins, device mismatches, unauthorized devices, and session timeouts. Dismissed items reappear on page refresh.
          </p>
        </div>
      </div>
    </div>
